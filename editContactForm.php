...
include('./_actions/editContact.php');
		...
		<div class="row justify-content-center">
			<div class="col-md-6">
				...
				<div>
					...
					<?php } ?>
					<form action="./_actions/editContact.php?id=<?= $id ?>" method="POST">
						<div class="form-group col-sm-6">
							<label for="phone">Phone:</label>
							<input type="text" class="form-control my-3" id="phone" name="phone" placeholder="Enter Phone" value="<?= $contact['phone'] ?? ''; ?>" required>
						</div>
						<div class="form-group">
							<label for="address" class="mb-2">Address:</label>
							<textarea class="form-control mb-3" name="address" id="exampleFormControlTextarea1" rows="3" placeholder="Enter your Address ..." required><?= $contact['address'] ?? ''; ?></textarea>
						</div>
						<div class="form-group">
							<label for="message" class="mb-2">Messages:</label>
							<textarea class="form-control mb-3" name="message" id="exampleFormControlTextarea1" rows="5" placeholder="Enter your Messages ..." required><?= $contact['message'] ?? ''; ?></textarea>
						</div>
						<button type="submit" class="btn btn-lg w-100 submit text-white" name="submit">Save Changes</button>
					</form>

					<div class="text-center mt-3 mb-5">
						<a class="violet" href="viewContact.php">Back to Contact List</a>
					</div>
				</div>
			</div>
		</div>
