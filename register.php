				...
				<div>
					<form action="" method="POST">
						<div class="form-floating mt-5">
							<input type="text" class="form-control my-3" id="fname" name="fname" placeholder="Enter FirstName" required>
							<label for="fname">First Name:</label>
						</div>
						<div class="form-floating">
							<input type="text" class="form-control my-3" id="lname" name="lname" placeholder="Enter LastName" required>
							<label for="lname">Last Name:</label>
						</div>
						<div class="form-floating">
							<input type="email" class="form-control my-3" id="email" name="email" placeholder="Enter Email" required>
							<label for="email">Email:</label>
						</div>
						<div class="form-floating">
							<input type="text" class="form-control my-3" id="username" name="username" placeholder="Enter Username" required>
						...
						<button type="submit" class="btn btn-lg w-100 submit text-white mb-3" name="submit">Register</button>
					</form>
				</div>
			</div>
		</div>
